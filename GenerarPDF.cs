...
namespace WebReportViewer
{
    public class GenerarPDF
    {
        public bool Generar()
        {
            ...
            a.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/Report1.rdlc");
            ...
            string imagePath = new Uri(HttpContext.Current.Server.MapPath("~/xamarin.png")).AbsoluteUri;
            string imagePath2 = new Uri(HttpContext.Current.Server.MapPath("~/home.png")).AbsoluteUri;
            ...
            File.WriteAllBytes(HttpContext.Current.Server.MapPath("~/" + DateTime.Now.ToString("ddMMyyyyHHmmss") + ".pdf"), bytes.ToArray()); // Requires System.Linq
